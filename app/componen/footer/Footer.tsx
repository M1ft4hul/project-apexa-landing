  ...
  return (
    <div className='footer'>
      <div className='bg-[#59859D] relative '>
        <div className='absolute 2xl:left-0 md:-left-16 md:block hidden top-5.625'>
          <img
            alt='...'
            loading='lazy'
            width={200}
            ...
            srcSet='/_next/image?url=%2Fimages%2Fshape%2Ffooter-v3-shapeline.png&w=256&q=75 1x, /_next/image?url=%2Fimages%2Fshape%2Ffooter-v3-shapeline.png&w=640&q=75 2x'
            src='/_next/image?url=%2Fimages%2Fshape%2Ffooter-v3-shapeline.png&w=640&q=75'
          />
        </div>
        <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md lg:px-0 px-0'>
          <div className='flex lg:items-center md:gap-0 gap-4 justify-between lg:flex-row flex-col pt-12 pb-8 border-b border-dark_border xl:px-0 px-6'>
            ...
            <div className='flex-1 lg:w-full md:max-w-70%'>
              <form>
                <div className='flex sm:items-center sm:flex-row flex-col sm:gap-10 gap-3'>
                  ...
                  <div className='flex flex-1'>
                    <input
                      ...
                      className='bg-darkInput border border-transparent focus:border-primary focus:outline-0 py-3 px-4 rounded-s-lg text-white w-full'
                      name='email'
                    />
                    <button className='bg-darkInput py-3 px-4 rounded-e-lg text-white'>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        xmlnsXlink='http://www.w3.org/1999/xlink'
                        aria-hidden='true'
                        role='img'
                        className='iconify iconify--ei'
                        width={24}
                        height={24}
                        viewBox='0 0 50 50'
                        ...
                        <path
                          fill='currentColor'
                          d='M37.1 13L9.4 24c-.9.3-.8 1.6.1 1.9l7 2.2l2.8 8.8c.2.7 1.1.9 1.6.4l4.1-3.8l7.8 5.7c.6.4 1.4.1 1.6-.6l5.4-23.2c.3-1.7-1.2-3-2.7-2.4M20.9 29.8L20 35l-2-7.2L37.5 15z'
                        />
                      </svg>
                    </button>
                  </div>
          ...
          <div className='py-12 border-b border-dark_border xl:px-0 px-6'>
            <div className='grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-3 lg:gap-0 gap-8 grid-cols-2'>
              <div>
                <p className='text-white text-base mb-4'>Explore</p>
                <ul>
                  <li className='py-2'>
                    <a
                  ...
                  <li className='py-2'>
                    <a
                      ...
                      href='#'>
                      Careers
                      <span className='bg-success py-1 px-2 rounded-lg ms-2 text-white'>
                        hiring!
                      </span>
                    </a>
                  </li>
              ...
              <div>
                <p className='text-white text-base mb-4'>Features</p>
                <ul>
                  <li className='py-2'>
                    <a
                      className='text-grey hover:text-white text-base duration-300'
              ...
              <div>
                <p className='text-white text-base mb-4'>Resources</p>
                <ul>
                  <li className='py-2'>
                    <a
                      className='text-grey hover:text-white text-base duration-300'
            ...
            <div className='flex items-center gap-6'>
              <a href='#'>
                <img
                  ...
                  srcSet='/_next/image?url=%2Fimages%2Ffooter%2Fapple-2.png&w=256&q=75 1x, /_next/image?url=%2Fimages%2Ffooter%2Fapple-2.png&w=384&q=75 2x'
                  src='/_next/image?url=%2Fimages%2Ffooter%2Fapple-2.png&w=384&q=75'
                />
              </a>
              <a href='#'>
                <img
                  ...
                  srcSet='/_next/image?url=%2Fimages%2Ffooter%2Fgp-2.png&w=256&q=75 1x, /_next/image?url=%2Fimages%2Ffooter%2Fgp-2.png&w=384&q=75 2x'
                  src='/_next/image?url=%2Fimages%2Ffooter%2Fgp-2.png&w=384&q=75'
                />
              </a>
            </div>
          </div>
